                ...
                <Form layout='horizontal'>
                    ...
                    <FormItem label="厂商" {...formItemLayout}>
                        {getFieldDecorator('makerId', { initialValue: formdata.makerId})(
                            <Select placeholder="请选择厂商" showSearch  onChange={this.onSearch.bind(this,'maker')}>
                                {makeroptions}
                            </Select>
                        )}
                    </FormItem>
                    <FormItem label="品牌" {...formItemLayout}>
                        {getFieldDecorator('brandId', { initialValue: formdata.brandId})(
                            <Select placeholder="请选择品牌" showSearch  onChange={this.onSearch.bind(this,'brand')}>
                                {brandoptions}
                            </Select>
                        )}
                    </FormItem>
                    <FormItem label="车系" {...formItemLayout}>
                        {getFieldDecorator('seriesId', { initialValue: formdata.seriesId})(
                            <Select placeholder="请选择车系" showSearch  onChange={this.onSearch.bind(this,'series')}>
                                {seriesoptions}
                            </Select>
                        )}
                    </FormItem>
                    <FormItem label="车型年款" {...formItemLayout}>
                        {getFieldDecorator('genreationYearId', { initialValue: formdata.genreationYearId })(
                            <Select placeholder="请选择车型年款" showSearch>
                                {genreationoptions}
                            </Select>
                        )}
                    </FormItem>
